...
$access_secret = "lbjgkgtuG44M1Kzb42JJnJjJpgRNqzQcMq7x7k3EKbA3u";

$twitter_screen_name = $_GET['twitter_screen_name'];
$tweets_to_display = (isset( $_GET['tweets_to_display'] ) AND $_GET['tweets_to_display'] != '') ? $_GET['tweets_to_display'] : 3;
...
$TweetPHP = new TweetPHP(array(
	...
	'cachetime'             => 10, // Seconds to cache feed

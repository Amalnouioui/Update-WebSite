...
if(isset($_POST['emailSent'])) {
	...
	$subject = 'Contact e-learning.cawtar.org';
					...
					<div class="row">
						<div class="col-md-6" style="float: right;">
							...
							<form id="contactFormAdvanced" action="<?php echo basename($_SERVER['PHP_SELF']); ?>#contact-sent" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-12">
										<input type="submit" id="contactFormSubmit" value="إرسل" class="btn btn-primary btn-lg pull-right" data-loading-text="Loading...">
									</div>
								</div>
							</form>
						</div>

		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container" style="margin-right: unset; margin-left: unset;">
					...
					<div class="row">
						<div class="col-md-6" style="itsfloat: right;">
							...
							if (isset($arrResult)) {
								...
								<div class="alert alert-success" id="contactSuccess">
									لقد تم إرسال رسالتك إلينا.
								</div>
								<?php
								} else if($arrResult['response'] == 'error') {
								?>
								<div class="alert alert-danger" id="contactError">
									<strong>خطأ!</strong> كان هناك خطأ أثناء إرسال رسالتك. (<?php echo $arrResult['error'];?>)
								</div>
								<?php
								} else if($arrResult['response'] == 'captchaError') {
								?>
								<div class="alert alert-danger" id="contactError">
									<strong>خطأ!</strong> فشل التحقق.
								</div>
								<?php
								}
							}
							...
							<h2 class="short"><strong>اتصال</strong> بنا</h2>
							<form id="contactFormAdvanced" action="<?php echo basename($_SERVER['PHP_SELF']); ?>#contact-sent" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="form-group">
										...
										<div class="col-md-6">
											...
											<input type="email" value="" data-msg-required="الرجاء إدخال عنوان البريد الإلكتروني الخاص بك." data-msg-email="رجاء قم بإدخال بريد الكتروني صحيح." maxlength="100" class="form-control" name="email" id="email" required>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>الرسالة *</label>
											<textarea maxlength="5000" data-msg-required="أدرج رسالتك من فضلك." rows="10" class="form-control" name="message" id="message" required></textarea>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12" style="display: flex;">
										<input type="submit" id="contactFormSubmit" value="إرسل" class="btn btn-primary btn-lg pull-right" style="border-color: #122b7d !important;color: #ffffff;text-shadow: 0 -1px 0 rgb(0 0 0 / 25%);background-color: #122b7d;border-color: #122b7d;width: 100%;margin: auto;max-width: 386px;" data-loading-text="Loading...">
									</div>
								</div>
							</form>
						</div>
